...
/**
 * list_len - It helps determine the length of linked list
...
/**
 * node_starts_with - This returns the node whose string starts with prefix
...
/**
 * get_node_index - This helps to get the index of a node
